"""
Django settings for dayboard project.
...
MIDDLEWARE = [
    ...
    'core.middleware.TokenValidationMiddleware',
...
WSGI_APPLICATION = 'dayboard.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PARSER_CLASSES': [
        'rest_framework.parsers.JSONParser',  # Support JSON parsing
    ],
}
...
if not DEBUG:
    REST_FRAMEWORK['DEFAULT_RENDERER_CLASSES'] = [
        'rest_framework.renderers.JSONRenderer',  # JSON-only renderer
    ]
